...
struct hda_alc269_dacinit {
	unsigned char value_0x23;
	unsigned char value_0x25;
};

void alc269_dolby_seq(struct hda_codec *codec, struct hda_alc269_dacinit *initval, int first)
{
	snd_hda_codec_write(codec, 0x6, 0, 0x73e, 0x0);
	alc_write_coef_idx(codec, 0x26, 0xb000);
	if (first) {
	  snd_hda_codec_write(codec, 0x21, 0, 0xf09, 0x0);  // 0x400
	}
	snd_hda_codec_write(codec, 0x6, 0, 0x73e, 0x80);
	alc_write_coef_idx(codec, 0x26, 0xf000);
	alc_write_coef_idx(codec, 0x23, initval->value_0x23);
	if (0x1e != initval->value_0x23)  {
		alc_write_coef_idx(codec, 0x25, initval->value_0x25);
	}
	snd_hda_codec_write(codec, 0x20, 0, AC_VERB_SET_COEF_INDEX, 0x26); // 0x500
	snd_hda_codec_write(codec, 0x20, 0, 0x4b0, 0x10);  // 0x400
}

void alc269_fixup_huawei_mbx_dolby(struct hda_codec *codec,
				     const struct hda_fixup *fix, int action)
{
	// Initialization magic
	static struct hda_alc269_dacinit dac_init[] = {
		{0xc, 0x0}, {0xd, 0x0}, {0xe, 0x0}, {0xf, 0x0},
		{0x10, 0x0}, {0x1a, 0x40}, {0x1b, 0x82}, {0x1c, 0x0}, {0x1d, 0x0}, {0x1e, 0x0}, {0x1f, 0x0},
		{0x20, 0xc2}, {0x21, 0xc8}, {0x22, 0x26}, {0x23, 0x24}, {0x27, 0xff}, {0x28, 0xff}, {0x29, 0xff},
		{0x2a, 0x8f}, {0x2b, 0x2}, {0x2c, 0x48}, {0x2d, 0x34}, {0x2e, 0x0}, {0x2f, 0x0},
		{0x30, 0x0}, {0x31, 0x0}, {0x32, 0x0}, {0x33, 0x0}, {0x34, 0x0}, {0x35, 0x1}, {0x36, 0x93},
		{0x37, 0xc}, {0x38, 0x0}, {0x39, 0x0}, {0x3a, 0xf8}, {0x38, 0x80},
		{}
	};
	struct hda_alc269_dacinit *seq = dac_init;
	...
	for (; seq->value_0x23; seq++) {
		alc269_dolby_seq(codec, seq, seq == dac_init);
	}
}
...
static const struct hda_fixup alc269_fixups[] = {
	...
	[ALC269_FIXUP_HUAWEI_MBX_DOLBY] = {
		.type = HDA_FIXUP_FUNC,
		.v.func = alc269_fixup_huawei_mbx_dolby,
		.chained = true,
		.chain_id = ALC255_FIXUP_MIC_MUTE_LED
	},
	[ALC269_FIXUP_ASUS_X101_FUNC] = {
...
static const struct snd_pci_quirk alc269_fixup_tbl[] = {
	...
	SND_PCI_QUIRK(0x19e5, 0x3200, "Huawei MBX", ALC269_FIXUP_HUAWEI_MBX_DOLBY),
	SND_PCI_QUIRK(0x19e5, 0x3201, "Huawei MBX", ALC269_FIXUP_HUAWEI_MBX_DOLBY),
